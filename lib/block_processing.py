...
"""
def calc_motion_vector_parallel_helper(frame: np.ndarray, frame_index: int, prev_frame: np.ndarray, prev_index: int, params, write_data_q: Queue, reconstructed_path: Path, pool: Pool) -> None:
    params_i = params.i
    params_r = params.r
    params_n = params.n
