...
class YUVProcessor:
    ...
    def __deconstruct(self) -> None:
        ...
        self.__config.output_path.meta_file.write_text(str("{},{},{},{},{},{}".format(self.__frame_index, self.info['paded_height'], self.info['paded_width'], self.__config.params.i, self.__config.params.qp, self.__config.params.nRefFrames)))
