                ...
                if vbs_enable:
                    ...
                    if vbs is VBSMarker.SPLIT:
                        ...
                        if fme_enable:
                            ...
                            label_dump[i].append(np.full(current_frame.raw[y_counter + top_left[0]:y_counter + top_left[0] + params_i, x_counter + top_left[1]:x_counter + top_left[1] + params_i].shape, label_init))
                else:
